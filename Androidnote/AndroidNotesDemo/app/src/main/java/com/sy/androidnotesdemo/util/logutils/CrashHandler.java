package com.sy.androidnotesdemo.util.logutils;
...
import com.sy.androidnotesdemo.util.DateUtils;
import com.sy.androidnotesdemo.util.FileUtils;
import java.io.File;
 ...
 * 功能描述：当程序发生Uncaught异常的时候，该类接管程序，并记录错误日志
 */
